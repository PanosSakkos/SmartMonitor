...
public class PlotActivity extends Activity {
	...
	private GraphicalView getAxisChart(String axis, int color) throws Exception {
		...
		List<Acceleration> accelerations = database
				.getAllAccelerations(AccelerationAxis.X);
		...
		// Date[] dateValues = new Date[] { new Date(95, 0, 1), new Date(95, 3,
		// 1), new Date(95, 6, 1),
		// new Date(95, 9, 1), new Date(96, 0, 1), new Date(96, 3, 1), new
		// Date(96, 6, 1),
		// new Date(96, 9, 1), new Date(97, 0, 1), new Date(97, 3, 1), new
		// Date(97, 6, 1),
		// new Date(97, 9, 1), new Date(98, 0, 1), new Date(98, 3, 1), new
		// Date(98, 6, 1),
		// new Date(98, 9, 1), new Date(99, 0, 1), new Date(99, 3, 1), new
		// Date(99, 6, 1),
		// new Date(99, 9, 1), new Date(100, 0, 1), new Date(100, 3, 1), new
		// Date(100, 6, 1),
		...
		setChartSettings(renderer, chartTitle, "Date", "%",
				dateValues[0].getTime(),
				dateValues[dateValues.length - 1].getTime(), min, max,
				Color.GRAY, Color.LTGRAY);
		renderer.setYLabels(10);
		// ChartFactory.getTimeChartIntent(this, buildDateDataset(titles, dates,
		// values),
		// renderer, "MMM yyyy");

		return ChartFactory.getTimeChartView(this,
